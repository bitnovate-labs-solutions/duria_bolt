...
const productData: { [key: string]: any } = {
  ...
  'd24-whole': {
    ...
    description: 'Traditional D24 variety known for its creamy texture and balanced flavor. This classic durian offers a perfect harmony of sweetness and creaminess that appeals to both newcomers and durian enthusiasts.',
    features: [
  ...
  'tekka-whole': {
    ...
    description: 'Sweet and mild Tekka durian, perfect for first-time durian tasters. This variety offers a gentle introduction to the world of durians with its mild, sweet flavor and smooth texture.',
    features: [
  ...
  'durian-sorbet': {
    ...
    description: 'Refreshing sorbet with pure durian flavor. A lighter alternative to ice cream, our durian sorbet offers the authentic taste of durian in a refreshing, dairy-free format.',
    features: [
      'Pure durian flavor',
      'Dairy-free sorbet',
      'Refreshing texture',
  ...
  'durian-gelato': {
    ...
    description: 'Italian-style gelato with rich durian cream. Our durian gelato combines the smooth, dense texture of traditional Italian gelato with the authentic flavor of premium durian.',
    features: [
  ...
  'durian-mochi': {
    ...
    description: 'Traditional Japanese mochi filled with premium durian cream. Each piece is handcrafted with authentic durian filling wrapped in soft, chewy mochi rice dough.',
    features: [
  ...
  'durian-mochi-ice-cream': {
    ...
    description: 'Mochi wrapped around durian ice cream for a unique treat. Experience the perfect combination of chewy mochi exterior and creamy durian ice cream center.',
    features: [
  ...
  'durian-mochi-gift-set': {
    ...
    description: 'Premium gift set featuring assorted durian mochi. Perfect for gifting, this set includes a variety of durian mochi flavors in elegant packaging.',
    features: [
  ...
  'mooncake-gift-set': {
    ...
    description: 'Luxurious gift set featuring traditional mooncakes with durian filling. Celebrate special occasions with our premium durian mooncakes in elegant packaging.',
    features: [
  ...
  'durian-mooncake-single': {
    ...
    description: 'Individual durian mooncake with authentic filling. Perfect for personal enjoyment or as a single serving of our premium durian mooncake.',
    features: [
  ...
  'premium-mooncake-box': {
    ...
    description: 'Elegant box containing 6 premium durian mooncakes. Our most luxurious mooncake offering, perfect for special celebrations and premium gifting.',
    features: [
      ...
      <section className="py-16 bg-gradient-to-br from-primary/5 to-primary/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center">
            <Badge className="mb-6 w-fit bg-primary/10 text-primary border-primary/20">{product.category}</Badge>
            ...
            <div className="flex items-center mb-6">
              ...
              <span className="ml-3 text-gray-600 text-lg">(4.9/5 based on 127 reviews)</span>
            </div>
            ...
            <div className="space-y-4 mb-10">
              <Button className="w-full bg-primary hover:bg-primary/90 text-lg py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" size="lg">
                Contact for Pricing & Availability
              </Button>
              <Button variant="outline" className="w-full text-lg py-6 rounded-xl border-2 hover:bg-primary/5 transition-all duration-300" size="lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover everything you need to know about this premium durian product
            </p>
          </div>
          ...
          <Tabs defaultValue="nutrition" className="mb-12">
            <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 bg-gray-100 p-1 rounded-2xl">
              <TabsTrigger value="nutrition" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">Nutrition</TabsTrigger>
              <TabsTrigger value="packaging" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">Packaging</TabsTrigger>
              <TabsTrigger value="benefits" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">Benefits</TabsTrigger>
              <TabsTrigger value="unique" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">Unique Traits</TabsTrigger>
            </TabsList>

                      <TabsContent value="nutrition" className="mt-8">
              <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  <h3 className="font-bold text-3xl mb-8 text-gray-900">Nutritional Information</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    {Object.entries(product.nutritional).map(([key, value]) => (
                      <div key={key} className="text-center p-6 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border border-primary/20">
                        <div className="font-bold text-gray-900 capitalize text-lg mb-2">
                          {key.replace(/([A-Z])/g, ' $1').trim()}
                        </div>
                        <div className="text-primary font-bold text-xl">{String(value)}</div>
                      </div>
                    ))}
                  </div>
                  <div className="flex items-center justify-center mt-10">
                    <div className="bg-green-50 rounded-2xl p-6 border border-green-200">
                      ...
                      />
                      <p className="text-center text-green-700 font-semibold mt-2">Halal Certified</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  <h3 className="font-bold text-3xl mb-8 text-gray-900">Packaging & Storage</h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div className="space-y-6">
                      <h4 className="font-bold text-2xl text-gray-900">Available Sizes</h4>
                      <div className="grid grid-cols-2 gap-4">
                        {product.packaging.sizes.map((size: string) => (
                          <div key={size} className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-4 border border-primary/20 text-center">
                            <span className="font-bold text-primary text-lg">{size}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    <div className="space-y-6">
                      <h4 className="font-bold text-2xl text-gray-900">Storage Information</h4>
                      <div className="space-y-4">
                        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                          <h5 className="font-bold text-blue-900 mb-2">Shelf Life</h5>
                          <p className="text-blue-700">{product.packaging.shelf_life}</p>
                        </div>
                        <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                          <h5 className="font-bold text-green-900 mb-2">Storage</h5>
                          <p className="text-green-700">{product.packaging.storage}</p>
                        </div>
                        <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                          <h5 className="font-bold text-purple-900 mb-2">Shipping</h5>
                          <p className="text-purple-700">{product.packaging.shipping}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  <h3 className="font-bold text-3xl mb-8 text-gray-900">Health Benefits</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {product.benefits.map((benefit: string) => (
                      <div key={benefit} className="flex items-start space-x-4 p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl border border-green-200 hover:shadow-lg transition-all duration-300">
          ...
          <TabsContent value="unique" className="mt-8">
            <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden">
              <CardContent className="p-8">
                <h3 className="font-bold text-3xl mb-8 text-gray-900">What Makes This Special</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {product.uniqueTraits.map((trait: string) => (
                    <div key={trait} className="flex items-start space-x-4 p-6 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border border-primary/20 hover:shadow-lg transition-all duration-300">
                      <Star className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                      <span className="text-gray-800 text-lg font-medium">{trait}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden bg-gradient-to-r from-primary/10 to-primary/20">
            <CardContent className="p-12 text-center">
              <Badge className="mb-6 bg-primary text-white px-6 py-2 text-lg rounded-full">Coming in Phase 2</Badge>
              <h3 className="text-4xl font-bold mb-6 text-gray-900">Recipe Videos & Ideas</h3>
              ...
              <Button variant="outline" className="text-lg px-8 py-4 rounded-xl border-2 hover:bg-primary hover:text-white transition-all duration-300">
