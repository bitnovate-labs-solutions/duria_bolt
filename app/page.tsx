...
const reviews = [
  {
    ...
    review: 'The Musang King durian I received was absolutely perfect. The texture was creamy, the flavor was rich and complex, and the delivery was impeccable. Will definitely order again!',
  ...
  },
  {
    ...
    review: 'As a durian connoisseur, I\'ve tried many suppliers, but Duria stands out for their consistent quality and authentic taste. The D24 pulp is exactly like what I remember from Malaysia.',
  ...
  },
  {
    ...
    review: 'The customer service is outstanding, and the durian ice cream is to die for! Perfect for introducing friends to durian. The packaging kept everything fresh during shipping.',
  ...
  },
  {
    ...
    review: 'Finally found durian that tastes like the real thing! The whole fruit was perfectly ripe and the flavor was incredible. Worth every penny for the premium quality.',
  ...
  },
  {
    ...
    rating: 5,
    title: 'Perfect Gift',
    review: 'Ordered the mooncake gift set for my parents and they were blown away. The durian filling was authentic and the presentation was beautiful. Highly recommend!',
  ...
  },
  {
    ...
    review: 'The frozen pulp arrived in perfect condition despite the long journey. The taste is exactly like fresh durian. Great for making desserts and smoothies.',
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link href="/products">
              <Button size="lg" className="bg-primary hover:bg-primary/90 px-8 py-4 text-lg font-semibold rounded-xl">
                View All Products
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link href="/about">
                <Button variant="outline" size="lg" className="border-primary text-primary hover:bg-primary hover:text-black px-8 py-4 text-lg font-semibold rounded-xl">
                  Learn More About Us
                </Button>
              </Link>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what durian enthusiasts worldwide 
              have to say about their Duria experience.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {reviews.map((review, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <h5 className="font-semibold text-lg text-black mb-3">{review.title}</h5>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center space-x-2 bg-primary/10 rounded-full px-6 py-3">
              ...
              <span className="text-black font-semibold ml-2">4.9/5 Average Rating</span>
            </div>
          </div>
        </div>
      </section>
